...
var messageTable = "X9709";
var messageContainer = "X6035";
var popup = "X9337";
var messageTime = "X3115";
var messageButton = "X9498";
var PMTag = "X6224";
var textBox = "X4361";
var visitorTable = "X9998";
...
function toggleChatLock() {
    if(X1020.X3590) { //Variable for whether the chat is locked, of course.
        postMessage("/open");
    } else {
        postMessage("/close");
    }
...
function editRoomBoard(message, method, key) {
    postMessage("/rb");
    setTimeout(function() {
        var BoardMessage = X2492("X9267").value; //THIS VAR IS THE ex-X0000 AND MAY BREAK STUFF DON'T PUSH TO MASTER W/O ASKING CRUXICHEIROS
        switch (method) {
            case 1:
